...
export const UserAuditLogFindManySelectSchema: z.ZodType<Prisma.UserAuditLogSelect> = z.object({
...
export const UserAuditLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    action: z.boolean().optional(),
...
export const UserAuditLogFindManySchema: z.ZodType<Prisma.UserAuditLogFindManyArgs> = z.object({ select: UserAuditLogFindManySelectSchema.optional(), include: z.lazy(() => UserAuditLogIncludeObjectSchema.optional()), orderBy: z.union([UserAuditLogOrderByWithRelationInputObjectSchema, UserAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserAuditLogWhereInputObjectSchema.optional(), cursor: UserAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserAuditLogScalarFieldEnumSchema, UserAuditLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UserAuditLogFindManyArgs>;

export const UserAuditLogFindManyZodSchema = z.object({ select: UserAuditLogFindManySelectSchema.optional(), include: z.lazy(() => UserAuditLogIncludeObjectSchema.optional()), orderBy: z.union([UserAuditLogOrderByWithRelationInputObjectSchema, UserAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserAuditLogWhereInputObjectSchema.optional(), cursor: UserAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserAuditLogScalarFieldEnumSchema, UserAuditLogScalarFieldEnumSchema.array()]).optional() }).strict();