...
export const UserAuditLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UserAuditLogSelect> = z.object({
...
export const UserAuditLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    action: z.boolean().optional(),
...
export const UserAuditLogFindFirstOrThrowSchema: z.ZodType<Prisma.UserAuditLogFindFirstOrThrowArgs> = z.object({ select: UserAuditLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => UserAuditLogIncludeObjectSchema.optional()), orderBy: z.union([UserAuditLogOrderByWithRelationInputObjectSchema, UserAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserAuditLogWhereInputObjectSchema.optional(), cursor: UserAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserAuditLogScalarFieldEnumSchema, UserAuditLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UserAuditLogFindFirstOrThrowArgs>;

export const UserAuditLogFindFirstOrThrowZodSchema = z.object({ select: UserAuditLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => UserAuditLogIncludeObjectSchema.optional()), orderBy: z.union([UserAuditLogOrderByWithRelationInputObjectSchema, UserAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserAuditLogWhereInputObjectSchema.optional(), cursor: UserAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserAuditLogScalarFieldEnumSchema, UserAuditLogScalarFieldEnumSchema.array()]).optional() }).strict();