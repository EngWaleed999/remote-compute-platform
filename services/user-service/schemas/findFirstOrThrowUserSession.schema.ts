...
export const UserSessionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UserSessionSelect> = z.object({
...
export const UserSessionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    token: z.boolean().optional(),
...
export const UserSessionFindFirstOrThrowSchema: z.ZodType<Prisma.UserSessionFindFirstOrThrowArgs> = z.object({ select: UserSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => UserSessionIncludeObjectSchema.optional()), orderBy: z.union([UserSessionOrderByWithRelationInputObjectSchema, UserSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserSessionWhereInputObjectSchema.optional(), cursor: UserSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserSessionScalarFieldEnumSchema, UserSessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UserSessionFindFirstOrThrowArgs>;

export const UserSessionFindFirstOrThrowZodSchema = z.object({ select: UserSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => UserSessionIncludeObjectSchema.optional()), orderBy: z.union([UserSessionOrderByWithRelationInputObjectSchema, UserSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserSessionWhereInputObjectSchema.optional(), cursor: UserSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserSessionScalarFieldEnumSchema, UserSessionScalarFieldEnumSchema.array()]).optional() }).strict();