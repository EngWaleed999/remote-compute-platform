...
export const LoginHistoryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LoginHistorySelect> = z.object({
...
export const LoginHistoryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    success: z.boolean().optional(),
...
export const LoginHistoryFindFirstOrThrowSchema: z.ZodType<Prisma.LoginHistoryFindFirstOrThrowArgs> = z.object({ select: LoginHistoryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LoginHistoryIncludeObjectSchema.optional()), orderBy: z.union([LoginHistoryOrderByWithRelationInputObjectSchema, LoginHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: LoginHistoryWhereInputObjectSchema.optional(), cursor: LoginHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LoginHistoryScalarFieldEnumSchema, LoginHistoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LoginHistoryFindFirstOrThrowArgs>;

export const LoginHistoryFindFirstOrThrowZodSchema = z.object({ select: LoginHistoryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LoginHistoryIncludeObjectSchema.optional()), orderBy: z.union([LoginHistoryOrderByWithRelationInputObjectSchema, LoginHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: LoginHistoryWhereInputObjectSchema.optional(), cursor: LoginHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LoginHistoryScalarFieldEnumSchema, LoginHistoryScalarFieldEnumSchema.array()]).optional() }).strict();