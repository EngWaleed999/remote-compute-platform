...
export const LoginHistoryFindManySelectSchema: z.ZodType<Prisma.LoginHistorySelect> = z.object({
...
export const LoginHistoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    success: z.boolean().optional(),
...
export const LoginHistoryFindManySchema: z.ZodType<Prisma.LoginHistoryFindManyArgs> = z.object({ select: LoginHistoryFindManySelectSchema.optional(), include: z.lazy(() => LoginHistoryIncludeObjectSchema.optional()), orderBy: z.union([LoginHistoryOrderByWithRelationInputObjectSchema, LoginHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: LoginHistoryWhereInputObjectSchema.optional(), cursor: LoginHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LoginHistoryScalarFieldEnumSchema, LoginHistoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LoginHistoryFindManyArgs>;

export const LoginHistoryFindManyZodSchema = z.object({ select: LoginHistoryFindManySelectSchema.optional(), include: z.lazy(() => LoginHistoryIncludeObjectSchema.optional()), orderBy: z.union([LoginHistoryOrderByWithRelationInputObjectSchema, LoginHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: LoginHistoryWhereInputObjectSchema.optional(), cursor: LoginHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LoginHistoryScalarFieldEnumSchema, LoginHistoryScalarFieldEnumSchema.array()]).optional() }).strict();